...
export default function SchoolSection() {
  return (
    <div className="py-16 2xl:py-20 text-[0.95rem] md:text-[1.1rem] 2xl:text-[1.2rem] flex-center flex-col justify-center w bg-[var(--darkBlue)] border-t-[1px] border-[#ffa500] text-white">
