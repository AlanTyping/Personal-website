...
export default function SchoolSection() {
  ...
  return (
    <motion.div
      ...
      className="overflow-hidden overflow-y-scroll gap-4 md:gap-6 px-[27px] text-[0.93rem] md:text-[1.15rem] 2xl:text-[1.4rem] z-40 lg:mt-[-120px] xl:mt-[-16px] flex-center flex-col justify-center w bg-[var(--secondary)] border-y border-[var(--tertiary)] text-white">
