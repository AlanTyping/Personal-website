...
export default function SchoolSection() {
  ...
  return (
    <motion.div
      ...
      className="overflow-hidden overflow-y-scroll gap-4 px-[27px] text-[0.90rem] z-40 lg:mt-[-120px] xl:mt-[-16px] md:text-[1.1rem] 2xl:text-[1.2rem] flex-center flex-col justify-center w bg-[var(--secondary)] border-y border-[var(--tertiary)] text-white">
