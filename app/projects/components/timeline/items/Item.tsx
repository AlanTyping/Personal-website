    ...
    <li>
      <div className="h-auto py-10 w-[98vw] flex flex-row justify-center items-center relative">
        ...
        <div className="h-auto w-full flex-center justify-center rounded mt-8">
          ...
          <Image src={image} alt='' className='hidden lg:flex w-[150%] brightness-[60%] top-0 h-auto rounded absolute' style={{ objectFit: 'cover' }} />
          <div className='hidden lg:flex absolute inset-x-0 inset-y-0 z-[1] bg-[#001b50d0]' />
