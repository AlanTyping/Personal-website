...
export const projects = [
    ...
    {
        name: "Speed Cube",
        descripcion: "Como me agrada resolver el cubo rubik en el menor tiempo posible, Desarrolle una app para calcular el promedio automáticamente después de 5 solves (Sólo para PC).",
        icon: web,
